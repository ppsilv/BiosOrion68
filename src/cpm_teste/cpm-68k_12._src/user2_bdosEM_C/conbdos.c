...
extern void     warmboot(WORD action);             /* External function definition */
...
void backsp(struct conbuf *bufp, WORD col)
{
...
void readline(p)                     /* BDOS function 10 */
REG struct conbuf *p;
